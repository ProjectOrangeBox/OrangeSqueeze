...
abstract class ValidateRule implements ValidateRuleInterface
{
	/**
	 ...
	 *
	 */
	public function field(&$field): ValidateRuleInterface
	{
		$this->field = &$field;
	 ...
	 * ```
	 */
	public function length($length = null): ValidateRuleInterface
	{
	 ...
	 * ```
	 */
	public function trim(): ValidateRuleInterface
	{
	 ...
	 * ```
	 */
	public function human(): ValidateRuleInterface
	{
	 ...
	 * ```
	 */
	public function human_plus(): ValidateRuleInterface
	{
	 ...
	 * ```
	 */
	public function strip($strip): ValidateRuleInterface
	{
