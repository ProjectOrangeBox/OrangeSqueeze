...
class UserModel extends MedooDatabaseModel implements UserModelInterface
{
	...
	protected $rules = [
		...
		'username' => ['field' => 'username', 'label' => 'User Name', 'rules' => 'required|trim|projectorangebox\auth\rules\aclUnique[users,username]'],
		'email' => ['field' => 'email', 'label' => 'Email', 'rules' => 'required|trim|strtolower|valid_email|projectorangebox\auth\rules\aclUnique[users,email]|max_length[255]|filter_input[255]'],
